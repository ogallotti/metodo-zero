...
- CLS no hero -> Fontes causando reflow -> display=swap ja resolve
...
- Script critico -> `<script src="modulo.js">` no HTML -> Remover, usar Dynamic Import
- FCP alto -> Muitos weights de fonte -> Reduzir para 2-3 weights
- Nota cai apos otimizar -> CSS async sem critical inline OU fontes async -> Reverter
