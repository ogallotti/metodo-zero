...
|-|-|-|-|
| GA4 - Config | GA4 Configuration | All Pages | Tracking basico |
| GA4 - Conversao Lead | GA4 Event | Form Submit | Marcar conversao |
| GA4 - Scroll Depth | GA4 Event | Scroll 50%, 90% | Engajamento |
| Google Ads - Conversao | Conversion Tracking | Page View - Obrigado | Conversao de anuncio |
| Google Ads - Remarketing | Remarketing | All Pages | Listas de remarketing |
...
4. O evento Lead e disparado ANTES do redirect

### Eventos duplicados
1. Verificar se o Pixel NAO esta no GTM E no HTML ao mesmo tempo
2. Verificar se Lead NAO esta sendo disparado na pagina de obrigado
3. Verificar se nao ha dois snippets do mesmo Pixel na pagina

### GTM nao aparece no preview
1. Verificar se o container foi publicado
