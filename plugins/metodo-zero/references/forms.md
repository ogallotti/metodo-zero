...
Apos submit bem-sucedido, o `showFeedback` exibe a mensagem. Para fechar o modal automaticamente apos a mensagem, adicionar apos `showFeedback`:
...
Para configurar os snippets de tracking, consulte `references/tracking.md`.
